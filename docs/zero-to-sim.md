...
- richer authoring, robot-profile metadata, MonsterBorg line-follow hardening fields, and physical-adapter metadata remain `experimental-foundation` and additive on the `v2.8.0` stable line
