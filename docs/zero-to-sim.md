...
- richer authoring, robot-profile metadata, MonsterBorg task-hardening fields, and physical-adapter metadata remain `experimental-foundation` and additive on the `v2.9.0-alpha.1` preview line
